...
class TorchHDemucsWrapper(nn.Module):
    ...
    def __init__(self,  **kwargs):
        ...
        self.samplerate = kwargs.pop('samplerate') # = samples_per_second
...
def get_model(args):
    extra = {
        ...
        'audio_channels': args.dset.channels, # SET THIS TO 2 IN YAML
...
def get_datasets(args):
    ...
    # ADDED FOR RF SEPARATION
    if args.dset.iq:
        train_set = IQDataset(args.dset.iq, sources=args.dset.sources, segment=args.dset.segment)
        valid_set = IQDataset(args.dset.iq_valid, sources=args.dset.sources, segment=args.dset.segment)
